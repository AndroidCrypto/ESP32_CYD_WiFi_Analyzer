...
/*
  Please uncomment just one entry for your CYD board
*/

#define CYD_1_9_INCHES_ST7789
//#define CYD_2_8_INCHES_ST7789
//#define CYD_2_8_INCHES_ILI9341
//#define CYD_3_5_INCHES_ST7796
...
#include <Arduino_GFX_Library.h> // https://github.com/moononournation/Arduino_GFX version 1.6.3

#ifdef CYD_1_9_INCHES_ST7789
  // CYD 1.9-inches 170x320 px
#define GFX_BL 21 // default backlight pin, you may replace DF_GFX_BL to actual backlight pin
  Arduino_DataBus *bus = new Arduino_SWSPI(2 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
  Arduino_GFX *gfx = new Arduino_ST7789(bus, DF_GFX_RST, 1 /* rotation */, false /* IPS */, 170 /* width */, 320 /* height */, 0 /* col offset 1 */, 0 /* row offset 1 */, 35, 0); 
#elif defined(CYD_2_8_INCHES_ST7789)
  // CYD 2.8-inches 240x320 px
#define GFX_BL 21 // default backlight pin, you may replace DF_GFX_BL to actual backlight pin
  Arduino_DataBus *bus = new Arduino_SWSPI(2 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
  Arduino_GFX *gfx = new Arduino_ST7789(bus, DF_GFX_RST, 1 /* rotation */, false /* IPS */, 240 /* width */, 320 /* height */, 0 /* col offset 1 */, 0 /* row offset 1 */); 
#elif defined(CYD_2_8_INCHES_ILI9341)
  // CYD 2.8-inches 240x320 px
#define GFX_BL 21 // default backlight pin, you may replace DF_GFX_BL to actual backlight pin
  Arduino_DataBus *bus = new Arduino_SWSPI(2 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
  Arduino_GFX *gfx = new Arduino_ILI9341(bus, DF_GFX_RST, 1 /* rotation */, false /* IPS */); 
#elif defined(CYD_3_5_INCHES_ST7796)
  // CYD 3.5-inches 320x480 px
#define GFX_BL 27 // default backlight pin, you may replace DF_GFX_BL to actual backlight pin
  Arduino_DataBus *bus = new Arduino_SWSPI(2 /* DC */, 15 /* CS */, 14 /* SCK */, 13 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
  Arduino_GFX *gfx = new Arduino_ST7796(bus, DF_GFX_RST, 1 /* rotation */, false /* IPS */, 320 /* width */, 480 /* height */, 0 /* col offset 1 */, 0 /* row offset 1 */); 
#endif
...
void setup()
{
  ...
  Serial.printf("text_size: %d banner_height: %d graph_baseline: %d graph_height: %d channel_width: %d signal_width: %d \n", text_size, banner_height, graph_baseline, graph_height, channel_width, signal_width);

  // init banner
  gfx->setTextSize(text_size);

#ifdef CYD_1_9_INCHES_ST7789
  gfx->invertDisplay(true); // CYD 1.9-inches
#elif defined(CYD_2_8_INCHES_ST7789)
  gfx->invertDisplay(false); // CYD 2.8-inches
#elif defined(CYD_2_8_INCHES_ILI9341)
  gfx->invertDisplay(false); // CYD 2.8-inches
#elif defined(CYD_3_5_INCHES_ST7796)
  gfx->invertDisplay(false); // CYD 3.5-inches
#endif
